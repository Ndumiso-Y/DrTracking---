    ...
    const INIT_DATA = [
        {
            id: 1, title: "Register Trade Name â€” Refodile Holdings", area: "Governance",
        ...
        },
        {
            ...
            short: { text: "Financial audit 2023â€“2026 initiated; practice audits in progress", due: "2026-04-30" },
        ...
        },
        {
            ...
            short: { text: "Draft roadmaps based on key driver analysis â€” post audit", due: "2026-05-31" },
        ...
        {
            id: 4, title: "Compile Partnership Agreement â€” Dr. Nape", area: "Governance",
        ...
        {
            id: 5, title: "Compile Partnership Agreement â€” Dr. Seabi", area: "Governance",
                ...
                <div class="m-content">
                    <div class="m-content-inner">
                        ...
                        <div style="margin: 0 24px 20px; background: var(--secondary-blue); border-radius: var(--radius-md); padding: 16px; border-left: 4px solid var(--primary-blue); font-size: 14px;">
                            <strong style="color: var(--primary-blue); display: block; margin-bottom: 4px;">ðŸŽ¯ What should I do here?</strong>
